...
1. **`issue-triage` `sdk/java` label** — Add `sdk/java` to the allowed labels list in the issue-triage workflow. See PR [1581](https://github.com/github/copilot-sdk/pull/1581)
